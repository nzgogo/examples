...
func (s *server) ChangHenGe(req *codec.Message, reply string) *router.Error {
	res := make(map[string]interface{},0)
	res["response"] = changhenge
	response := codec.NewResponse( req.ContextID,200, res, req.Header)
	s.srv.Respond(response, reply)
	return nil
}
